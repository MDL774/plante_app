...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _classifyImage(File imageFile) async {
    ...
    try {
      ...
      // 2. Redimensionner à 224x224 (MobileNetV2)
      int inputSize = 224;
      ...
      // 4. Remplir avec les pixels normalisés
      ...
      // 6. Afficher les résultats (debug)
      for (int i = 0; i < _labels.length; i++) {
        print("${_labels[i]}: ${(output[0][i] * 100).toStringAsFixed(1)}%");
      }
